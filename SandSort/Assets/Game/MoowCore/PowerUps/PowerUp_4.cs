...
public class PowerUp_4 : BasePowerUp
{
    public PowerUp_4_State state { get; private set; }
    ...
    {
        if (state == PowerUp_4_State.ACTIVE)
        {
        ...
        state = PowerUp_4_State.ACTIVE;
        show();
    }

    void show()
    {
        this.dispatchEvent<object>(Events.POWER_UP_4_ACTIVATED, null);
    }
    void hide()
    {
        state = PowerUp_4_State.DEACTIVE;
        this.dispatchEvent<object>(Events.POWER_UP_4_DEACTIVATED, null);
    }

    public enum PowerUp_4_State
    {
        DEACTIVE,
        ANIMATING,
        ACTIVE
